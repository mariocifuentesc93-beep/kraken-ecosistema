...
class TelegramSelector(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btnTest = QPushButton("Probar")

        self.btnSync = QPushButton("Sincronizar")
        ...
        buttons.addWidget(self.btnTest)

        buttons.addWidget(self.btnSync)
